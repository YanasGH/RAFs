...
########## Random Activation Functions (RAFs) Ensemble ##########
...
viz_one_d(dname, train, test, "RAFs Ensemble", method_means, method_stds, predictions, False) # change to True if you want to save the plot

"""Report metrics:"""

report_res(dname, test, y_val, "RAFs Ensemble", method_means, method_stds, scaler_X, scaler_y)