...
def get_randomized_prior_nn():
    ...
    trainable_net = Sequential([Dense(128, 'tanh'), 
                                Dense(128, 'tanh')], 
    ...
    prior_net = Sequential([Dense(128, 'tanh', kernel_initializer='glorot_normal',trainable=False),  
                            Dense(128, 'tanh', kernel_initializer='glorot_normal',trainable=False)],     
...
viz_one_d(dname, train, test, "RP-param", method_means, method_stds, predictions, True)

"""Report metrics:"""

report_res(dname, y_val, "RP-param", method_means, method_stds)