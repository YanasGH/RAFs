...
########## NTKG-param (He et al.) ##########
###  Code mainly based on the repository , which can be found at https://github.com/bobby-he/bayesian-ntk ###
...
method_input_dct = {"NTKGP-param": 'ntkgp_param'}
...
# train ensembles
ensemble_methods_list = ['NTKGP-param']
...
# display the results
method_moments = predictions["NTKGP-param"]
method_means = method_moments.mean.reshape(-1,)
method_stds = method_moments.standard_deviation.reshape(-1,)
viz_one_d(dname, train, test, "NTKGP-param", method_means, method_stds, predictions, False) # change to True if you want to save the plot
